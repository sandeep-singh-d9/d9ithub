    ...
    <div class="main_top_content">
      ...
      <div class>
                ...
                <div class="inner_portfolio">
                  ...
                  <div class="pie-context">
                    ...
                    <ul style="text-align:left;">
                      <li>
                        <b>Transparency</b> so the public can see how government turns taxpayer money into projects and services..
                      </li>
                      <li>
        ...
        <div class="mobile">
          ...
          <!-- <div class="navigation">
            <button @click="newentry++" :disabled="newentry==12"><i class="icon-circle-arrow-right"></i></button>
            <button @click="newentry--" :disabled="newentry==1" ><i class="icon-circle-arrow-left"></i></button>
          </div> -->
          <!-- ------------------one  -------------->
