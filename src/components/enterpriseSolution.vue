<template>
  <div class="main_top_content">
    ...
    <div class="webdevelopment_services all_services Enterprise_Solutions ">
        <div class="col-sm-6 left_services">
            <div class="services_text">
              <h2>Enterprise Solutions </h2>
              <ul>
                  <li><a class="development_menu_tab" href="#php">Enterprice System Integration</a></li>
                  <li><a class="development_menu_tab" href="#laravel">Customer Relation Management</a></li>
                  <li><a class="development_menu_tab" href="#vue">IoT</a></li>
                  <li><a class="development_menu_tab" href="#wordpress">Machine Learning</a></li>
                  <li><a class="development_menu_tab" href="#react">Artificial Intelligence</a></li>
    ...
    <!-- php development  -->
      <div class="php all_services Enterprice_System " id="php">
          <div class="col-sm-6 right_services"><div class="bg_img"></div></div>
          <div class="col-sm-6 left_services">
              <div class="services_text">
                <h2>Enterprice System Integration</h2>
    ...
    <!-- laravel development -->
        <div class="laravel all_services Customer_Relation" id="laravel">
          <div class="col-sm-6 left_services">
              <div class="services_text">
    ...
    <!-- vue development -->
        <div class="vue all_services IoT" id="vue">
          <div class="col-sm-6 right_services"><div class="bg_img"></div></div>
          <div class="col-sm-6 left_services">
              <div class="services_text iot">
                <h2>IoT</h2>
    ...
    <!-- Wordpress development -->
        <div class="wordpress all_services Machine_Learning" id="wordpress">
          <div class="col-sm-6 left_services">
              <div class="services_text">
    ...
    <!-- React development  -->
      <div class="android all_services Artificial_Intelligence" id="react">
          <div class="col-sm-6 right_services"><div class="bg_img"></div></div>
          <div class="col-sm-6 left_services">
              <div class="services_text ai">
